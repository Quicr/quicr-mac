    ...
    private func doPreview(device: AVCaptureDevice) {
        ...
        sessionQueue.async { [unowned self] in
            ...
            do {
                ...
                print("[PreviewView] Failed to remove existing device: \(self.device.localizedName)")
            }
            ...
            do {
                ...
                print("[PreviewView] Failed to add new device: \(device.localizedName)")
            }
            self.device = device
...
struct PreviewView: UIViewControllerRepresentable {
    ...
    func updateUIViewController(_ uiViewController: UIViewController, context: Context) {
        ...
        if let preview = uiViewController as? PreviewViewInternal {
            guard preview.device == self.device else {
                print("[PreviewView] Updating target device to: \(self.device.localizedName)")
